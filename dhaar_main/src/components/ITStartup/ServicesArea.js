...
import IOT from "../../assets/images/services-left-image/iot.jpg";
            ...
            <div className="col-lg-6 col-md-12 services-content">
              <div className="section-title">
                ...
                <p>
                  ...
                  Automotive Embedded Software Products and Services. We believe
                  in our strong team with specialization in AUTOSAR, Automotive
                  Systems, Embedded Software, ISO 26262 and In-Vehicle
                  Networking.
                </p>
              </div>
          ...
          <div className="row h-100 justify-content-center align-items-center">
            ...
            <div className="col-lg-6 col-md-12 services-content">
              ...
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Layout /> Fast Prototype
                  </div>
                </div>

                <div className="col-lg-6 col-md-6">
                  <div className="box">
                    <Icon.Code /> Concept Development
                  </div>
                </div>
